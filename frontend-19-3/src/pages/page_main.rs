...
// use crate::state::lillaost_state::LillaOstState;

use crate::components::daily_summary::DailySummary;
...
impl Component for PageMain {
    ...
    fn view(&self, _ctx: &Context<Self>) -> Html {
        ...
        //                 <Link<LillaOstRoutes> classes=classes!(vec!["button", "is-success"]) route=LillaOstRoutes::Settings >
        //                     {"Go to settings"}
        //                 </Link<LillaOstRoutes>>
        //             </footer>
        //         </div>
        ...
        //             <DailySummary />
        //             <div class="block">
        //                 <EventListing page=self.props.page />
        //             </div>
        //             <p></p>
        //         </div>
        //     };
        ...
        // if sto.borrow().ost_len_active() == 0 {
